...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="container flex mx-auto px-4 py-8 ">
        <div class=" flex-grow h-full border border-red-400">
        ...
        <button data-modal-target="default-modal" data-modal-toggle="default-modal" class="w-full " type="button">
            <div class="justify-end bg-white rounded-lg shadow-md p-6 mb-8">  
                <p href="post/post-card.php" class="text-xl font-semibold mb-4 ">What's on your mind?</p>               
        </button>
                ...
                <div class="p-6">
                    <div class="flex items-center mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Posted on: <?php echo date('F j, Y'); ?></p>
                        </div>
                    </div>
