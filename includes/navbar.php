<div class="sticky top-0 flex justify-end p-4 border shadow-md bg-white">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white">
                ...
                if(isset($_SESSION["username"])) { ?>
                    <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="flex justify-center items-center" type="button"><?php echo $_SESSION["fullName"]?> <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
