  ...
  <div class="max-w-4xl mx-auto py-2 px-4">
    ...
    <div class="flex items-center space-x-4">
      ...
      <div>
        ...
        <h1 class="text-gray-400">@gmail.com</h1>
...
<div class="border-b border-gray-200 dark:border-gray-700">
    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
        ...
        <li class="me-2">
            <a href="user/user_post.php" class="inline-flex items-center justify-center p-4 text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500 group" aria-current="page">
